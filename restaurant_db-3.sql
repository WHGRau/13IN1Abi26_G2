...
--
-- Host: localhost
-- Erstellungszeit: 06. Okt 2025 um 19:22
...
CREATE TABLE `oeffnungszeiten` (
  ...
  `oeffnet` time NOT NULL,
  `schliesst` time NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `oeffnungszeiten` (`id`, `wochentag`, `oeffnet`, `schliesst`) VALUES
(1, 'Montag', '17:00:00', '22:00:00'),
(2, 'Dienstag', '17:00:00', '22:00:00'),
(3, 'Mittwoch', '17:00:00', '22:00:00'),
(4, 'Donnerstag', '17:00:00', '22:00:00'),
(5, 'Freitag', '17:00:00', '00:00:00'),
(6, 'Samstag', '17:00:00', '00:00:00'),
(7, 'Sonntag', '17:00:00', '21:30:00');
